...
export class EmailService {
  ...
  static async sendCustomerInvite(
    ...
    const html = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h2>Welcome to LoanHub Customer Portal</h2>
        <p>Hello ${firstName},</p>
        ...
        <p>Best regards,<br>The LoanHub Team</p>
      </div>
    `;

    return this.sendEmail({
      to: email,
      subject: 'Welcome to LoanHub Customer Portal',
      html,
      text: `Welcome to LoanHub! Access your portal at ${url} using email: ${email} and temporary password: ${temporaryPassword}. You will be required to change your password on first login.`,
    });
  }
