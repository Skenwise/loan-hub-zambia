      ...
      const plans = [
        {
          planName: 'Starter',
          pricePerMonth: 59,
          features: 'basic_reporting,customer_management,loan_management,kyc_verification,loan_origination,payment_processing,basic_analytics',
          usageLimits: 'max_customers:100,max_loans:100',
        ...
        },
        {
          ...
          usageLimits: 'max_customers:1000,max_loans:1000',
